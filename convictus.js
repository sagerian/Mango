...
{
	if (region.ae.E === region.al.E)
	{
		return 'on line ' + region.ae.E;
	}
	return 'on lines ' + region.ae.E + ' through ' + region.al.E;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {an: fragment, ap: host, aL: path, aO: port_, aR: protocol, aS: query};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{y: $author$project$Main$homeContent, Y: 'purple', aN: 'lobes', aW: 0},
		...
		switch (msg) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{y: $author$project$Main$homeContent}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{y: $author$project$Main$krewContent}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{y: $author$project$Main$aboutUsContent}),
					$elm$core$Platform$Cmd$none);
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', model.Y)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$ClickedAboutUs = 2;
var $author$project$Main$ClickedHome = 0;
var $author$project$Main$ClickedKrew = 1;
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{bc: $author$project$Main$init, bi: $author$project$Main$subscriptions, bk: $author$project$Main$update, bl: $author$project$Main$view});
